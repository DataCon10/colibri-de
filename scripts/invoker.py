...
def main():
    ...
    # Compute statistics and identify outliers
...
# df_standardised_for_nulls = df.withColumn("power_output",
#                                 F.when(F.col("power_output").isin('', '0'), None)
#                                 .otherwise(F.col("power_output")))
# df_filtered = df_standardised_for_nulls.filter(df.power_output.isNotNull())
#
#
